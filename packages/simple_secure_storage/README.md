...
In the previous snippet, everything is read "on demand". Although in most implementations your data
already cached on the memory on the platform side, you may want to access it without always using
