...
Simple Secure Storage is setup to run with the most recent `stable` version of Flutter, so make sure your version
matches that :
...
Also, Simple Secure Storage uses [Melos] to manage the project and dependencies.
...
Go to the [pull request page of Simple Secure Storage][PRs] and in the top
...
These instructions are for the maintainers of Simple Secure Storage.
...
[GitHub issue]: https://github.com/Skyost/SimpleSecureStorage/issues
[GitHub issues]: https://github.com/Skyost/SimpleSecureStorage/issues
[PRs]: https://github.com/Skyost/SimpleSecureStorage/pulls
